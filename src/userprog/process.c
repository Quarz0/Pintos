...
static bool setup_stack (void **esp, const char *arg0, const char *args);
...
/* Create a minimal stack by mapping a zeroed page at the top of
   user virtual memory. */
static bool
setup_stack (void **esp, const char *arg0, const char *args)
{
  uint8_t *kpage;
  bool success = false;
